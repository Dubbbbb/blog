# Generated by Django 3.2.6 on 2021-09-14 18:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(related_name='posts', to='blog_home.Tag')),
            ],
            options={
                'verbose_name': 'Post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('editer', models.DateTimeField(auto_now=True, verbose_name='Date of edit comment.')),
                ('is_moderated', models.DateTimeField(auto_now=True, verbose_name='If moderated.')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='comments')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='blog_home.post')),
            ],
            options={
